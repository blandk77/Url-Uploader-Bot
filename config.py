...
class Config(object):
    ...
    TECH_VJ_URL = environ.get('TECH_VJ_URL', 'primeurl.in') # your shortlink url domain or url without https://
    TECH_VJ_API = environ.get('TECH_VJ_API', '54b3c3604b9dfef1c127a9e999be1ec4f533dd7e') # your url shortner api
